    ...
    <table align="center">
        <tr>
         ...
         <tr>
            ...
            <td>
                <asp:Label ID="lblAccountType" runat="server" Text="Saving" ></asp:Label>
            </td>
        </tr>
         <tr>
           <td style="width:50%">
           ...
           <td style="width:50%">
            ...
            <td>
                ...
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                    ConnectionString="<%$ ConnectionStrings:BankingTransactionDBConnectionString %>" ProviderName="<%$ ConnectionStrings:BankingTransactionDBConnectionString.ProviderName %>" 
           ...
           <td style="width:50%">
            ...
            <td>
               ...
               <div>
                    ...
                    ErrorMessage="Amount length must be between 1 to 5 digits" ControlToValidate="txtAmount" ForeColor="Red"
